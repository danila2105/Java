...
public class NewJFrame extends javax.swing.JFrame {
    ...
    if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
        ...
        try (FileWriter writer = new FileWriter(file)) {
            ...
            JOptionPane.showMessageDialog(this, "JSON-файл сохранён успешно!", "Успешно", JOptionPane.INFORMATION_MESSAGE);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Ошибка при сохранении JSON-файла!", "Ошибка", JOptionPane.ERROR_MESSAGE);
        }
    }
}
    ...
    if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
        ...
        try (FileReader fileReader = new FileReader(file)) {
            Gson gson = new Gson();
            java.lang.reflect.Type listType = new com.google.gson.reflect.TypeToken<ArrayList<RecIntegral>>() {}.getType();
            ArrayList<RecIntegral> loadedRecords = gson.fromJson(fileReader, listType);

            if (loadedRecords != null) {
                records = loadedRecords;
                JOptionPane.showMessageDialog(this, "JSON-файл загружен успешно!", "Успешно", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "JSON-файл пуст или поврежден", "Ошибка", JOptionPane.ERROR_MESSAGE);
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Ошибка при загрузке JSON-файла!", "Ошибка", JOptionPane.ERROR_MESSAGE);
        }
    }
}
