...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void sendTask(int clientId, double a, double b, double h) {
        ...
        int clientPort = clientPorts.get(clientId); // Берём порт клиента
        ...
        try (DatagramSocket serverSocket = new DatagramSocket(SERVER_PORT)) {
            ...
            while (results.size() < clientPorts.size()) {
                ...
                if (message.startsWith("RESULT:")) {
                    ...
                    String ackMessage = "ACK:" + clientId;
                    byte[] ackData = ackMessage.getBytes("UTF-8");
